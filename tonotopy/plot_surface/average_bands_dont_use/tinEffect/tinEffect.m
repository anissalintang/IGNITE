...
%%
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/tinEffect/tinEffect_lh.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/tinEffect/tinEffect_rh.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('Averaged stimuli evoked response in temporal region, Tin vs noTin')
...
% Save the figure
saveas(gcf, [outputDir, 'tinEffect_temporal_smooth5.png']);
