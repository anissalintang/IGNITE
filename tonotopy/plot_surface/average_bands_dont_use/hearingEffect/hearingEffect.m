...
%%
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/hearingEffect/hearingEffectPercentile_lh.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/hearingEffect/hearingEffectPercentile_rh.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
scaled_data = (min(max(all_data, -0.3), 0.3) + 0.3) / (0.3*2);
...
sgtitle('Averaged stimuli evoked response in temporal region, Hard hearing vs Normal Hearing')
...
% Save the figure
saveas(gcf, [outputDir, 'hearingEffect_temporal_smooth5.png']);
