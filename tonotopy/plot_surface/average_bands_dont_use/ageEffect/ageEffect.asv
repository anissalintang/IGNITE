...
%%
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/ageEffect/ageEffectPercentile_lh.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/ageEffect/ageEffectPercentile_rh.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('Averaged stimuli evoked response in temporal region, Old vs Young')
...
% Save the figure
saveas(gcf, [outputDir, 'ageEffect_temporal_smooth5.png']);
