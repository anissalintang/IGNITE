...
%%
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/stimEffect/stimEffect_lh.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/stimEffect/stimEffect_rh.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('Averaged stimuli evoked response in temporal region, Vis vs Rest')
...
% Save the figure
saveas(gcf, [outputDir, 'stimEffect_temporal_smooth5.png']);
