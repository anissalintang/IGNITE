...
%%
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/motionEffect/motionEffectPercentile_lh.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/tonotopy/surface/analysis/motionEffect/motionEffectPercentile_rh.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('Averaged stimuli evoked response in temporal region, More vs Less movements')
...
% Save the figure
saveas(gcf, [outputDir, 'motionEffect_temporal_smooth5.png']);
