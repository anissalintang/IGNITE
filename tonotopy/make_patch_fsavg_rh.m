function make_patch_fsavg_rh(pth,THR,AZ,FLIPX,FLIPY)
%     AZ = 0;
%     THR = 50;
%     FLIPX = 0;
%     FLIPY = 0;
    ...
    save(fullfile(pth_o,'patch','surf_fsavg_rh.mat'))

    % 2. Create patch;  
    mri = MRIread(fullfile(pth,'probActMap','probActMap.rh.fsavg.mgz'));
    VOL = mri.vol; 
    mri = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/destrieux_fsavg/temporalLobe_mask_rh.mgh');
    ...
    save(fullfile(pth_o,'patch','patch_fsavg_rh.mat'),'ptch','roi') 
    ...
    MRIwrite(mri,fullfile(fullfile(pth_o,'patch','roi.rh.fsavg.mgz')));     
