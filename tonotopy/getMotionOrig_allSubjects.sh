...
# Directory paths
BASE_DIR="/Volumes/gdrive4tb/IGNITE/tonotopy/preprocessed"

mkdir -p /Volumes/gdrive4tb/IGNITE/tonotopy/motionOrig

OUTPUT_DIR="/Volumes/gdrive4tb/IGNITE/tonotopy/motionOrig"

ABS_FILE="${OUTPUT_DIR}/IGNITE_tonotopy_motionOrig_abs.txt"
REL_FILE="${OUTPUT_DIR}/IGNITE_tonotopy_motionOrig_rel.txt"
