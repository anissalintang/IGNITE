...
%% ALFF hearingEffect pctl
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/hearingEffect/ALFF_lh_hearingEffect_percentiles.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/hearingEffect/ALFF_rh_hearingEffect_percentiles.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('ALFF PTA Effect Percentile (higher-lower)')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/ALFF_hearingEffect_higher_lower_pctl.png');
