...
%% GCOR noTin
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/merge_mean/allSubj_lh_GCOR_wholeBrain_merged_mean_noTin_smooth5.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/merge_mean/allSubj_rh_GCOR_wholeBrain_merged_mean_noTin_smooth5.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
scaled_data = (min(max(all_data, -0.04), 0.04) + 0.04) / (0.04*2);
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_merge_mean_noTin.png');


%% GCOR Tin
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/merge_mean/allSubj_lh_GCOR_wholeBrain_merged_mean_tin_smooth5.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/merge_mean/allSubj_rh_GCOR_wholeBrain_merged_mean_tin_smooth5.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_merge_mean_tin.png');