...
%% ALFF noTin
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/merge_mean/allSubj_lh_ALFF_merged_mean_noTin_smooth5.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/merge_mean/allSubj_rh_ALFF_merged_mean_noTin_smooth5.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/ALFF_merge_mean_noTin.png');


%% ALFF Tin
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/merge_mean/allSubj_lh_ALFF_merged_mean_tin_smooth5.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/merge_mean/allSubj_rh_ALFF_merged_mean_tin_smooth5.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/ALFF_merge_mean_tin.png');