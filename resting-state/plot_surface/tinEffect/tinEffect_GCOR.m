...
%% GCOR all
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_wholeBrain_lh_tinEffect_smooth5.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_wholeBrain_rh_tinEffect_smooth5.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
RANGE = 0.5; OFFSET = min(1-RANGE,0.02);
...
scaled_data = (min(max(all_data, -0.02), 0.02) + 0.02) / 0.04;
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_noTin_tin.png');


%% GCOR all younger median
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_lh_tinEffect_tin_noTin_smooth5_younger.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_rh_tinEffect_tin_noTin_smooth5_younger.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_noTin_tin_younger_median.png');

%% GCOR all older median
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_lh_tinEffect_tin_noTin_smooth5_older.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_rh_tinEffect_tin_noTin_smooth5_older.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_noTin_tin_older_median.png');

%% GCOR all younger 25th percentile
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_lh_tinEffect_tin_noTin_smooth5_younger_25pctl.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_rh_tinEffect_tin_noTin_smooth5_younger_25pctl.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_noTin_tin_younger_25pctl.png');

%% GCOR all older 75th percentile
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_lh_tinEffect_tin_noTin_smooth5_older_75pctl.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/tinEffect/smooth5/GCOR_rh_tinEffect_tin_noTin_smooth5_older_75pctl.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_noTin_tin_older_75pctl.png');