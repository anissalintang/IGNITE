...
%% GCOR ageEffect median
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/ageEffect/GCOR_lh_ageEffect.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/ageEffect/GCOR_rh_ageEffect.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('GCOR Age Effect (older-younger)')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_ageEffect_older_younger_median.png');


%% GCOR ageEffect pctl
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/ageEffect/GCOR_lh_ageEffect_percentiles.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/ageEffect/GCOR_rh_ageEffect_percentiles.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('GCOR Age Effect Percentile (older-younger)')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_ageEffect_older_younger_pctl.png');
