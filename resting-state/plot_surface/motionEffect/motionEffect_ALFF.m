...
%% ALFF motionEffect median
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/motionEffect/ALFF_lh_motionEffect.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/motionEffect/ALFF_rh_motionEffect.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('ALFF Motion Effect (movMore-movLess)')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/ALFF_motionEffect_movMore_movLess_median.png');


%% ALFF motionEffect pctl
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/motionEffect/ALFF_lh_motionEffect_percentiles.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/motionEffect/ALFF_rh_motionEffect_percentiles.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('ALFF Motion Effect Percentile (movMore-movLess)')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/ALFF_motionEffect_movMore_movLess_pctl.png');
