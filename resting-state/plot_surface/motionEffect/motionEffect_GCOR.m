...
%% GCOR motionEffect median
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/motionEffect/GCOR_lh_motionEffect.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/motionEffect/GCOR_rh_motionEffect.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
scaled_data = (min(max(all_data, -0.015), 0.015) + 0.015) / (0.015*2);
...
sgtitle('GCOR Motion Effect (movMore-movLess)')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_motionEffect_movMore_movLess_median.png');


%% GCOR motionEffect pctl
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/motionEffect/GCOR_lh_motionEffect_percentiles.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR/motionEffect/GCOR_rh_motionEffect_percentiles.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('GCOR Motion Effect Percentile (movMore-movLess)')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/keyFigures/GCOR_motionEffect_movMore_movLess_pctl.png');
