...
%%
load('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/with_motionParam/ALFF_lme.mat');
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/ALFF_tmap_tinStat_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/ALFF_tmap_tinStat_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/ALFF_tmap_PTA_mean_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/ALFF_tmap_PTA_mean_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/ALFF_tmap_Age_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/ALFF_tmap_Age_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/with_motionParam/fullmod/ALFF_tmap_MotionAbsMean_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/with_motionParam/fullmod/ALFF_tmap_MotionAbsMean_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/with_motionParam/fullmod/ALFF_tmap_MotionRelMean_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/with_motionParam/fullmod/ALFF_tmap_MotionRelMean_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/ALFF_tmap_hemis-PTA_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/stat/ALFF_tmap_hemis-PTA_fullMod_corrected_%g.mgz', alpha));
end
