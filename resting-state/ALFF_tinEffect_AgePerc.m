...
dataDir = '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF';
...
diff_younger_lh = mean(cat(1, lh_TT_younger.imgData), 1) - mean(cat(1, lh_NT_younger.imgData), 1);
diff_older_lh = mean(cat(1, lh_TT_older.imgData), 1) - mean(cat(1, lh_NT_older.imgData), 1);
diff_younger_rh = mean(cat(1, rh_TT_younger.imgData), 1) - mean(cat(1, rh_NT_younger.imgData), 1);
diff_older_rh = mean(cat(1, rh_TT_older.imgData), 1) - mean(cat(1, rh_NT_older.imgData), 1);
...
MRIwrite(diff_younger_lh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/tinEffect/smooth5/ALFF_lh_tinEffect_tin_noTin_smooth5_younger.mgz');
MRIwrite(diff_older_lh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/tinEffect/smooth5/ALFF_lh_tinEffect_tin_noTin_smooth5_older.mgz');
MRIwrite(diff_younger_rh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/tinEffect/smooth5/ALFF_rh_tinEffect_tin_noTin_smooth5_younger.mgz');
MRIwrite(diff_older_rh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/tinEffect/smooth5/ALFF_rh_tinEffect_tin_noTin_smooth5_older.mgz');
...
MRIwrite(diff_younger_lh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/tinEffect/smooth5/ALFF_lh_tinEffect_tin_noTin_smooth5_younger_25pctl.mgz');
MRIwrite(diff_older_lh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/tinEffect/smooth5/ALFF_lh_tinEffect_tin_noTin_smooth5_older_75pctl.mgz');
MRIwrite(diff_younger_rh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/tinEffect/smooth5/ALFF_rh_tinEffect_tin_noTin_smooth5_younger_25pctl.mgz');
MRIwrite(diff_older_rh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/tinEffect/smooth5/ALFF_rh_tinEffect_tin_noTin_smooth5_older_75pctl.mgz');
