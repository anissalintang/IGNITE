...
diff_lh = mean(cat(1, movMore_lh.imgData), 1) - mean(cat(1, movLess_lh.imgData), 1);
diff_rh = mean(cat(1, movMore_rh.imgData), 1) - mean(cat(1, movLess_rh.imgData), 1);
...
MRIwrite(diff_lh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/motionEffect/ALFF_lh_motionEffect.mgz');
MRIwrite(diff_rh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/motionEffect/ALFF_rh_motionEffect.mgz');
...
MRIwrite(diffPercentile_lh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/motionEffect/ALFF_lh_motionEffect_percentiles.mgz');
MRIwrite(diffPercentile_rh_img, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF/motionEffect/ALFF_rh_motionEffect_percentiles.mgz');
