...
lmeFormula = 'Response ~ 1 + Sex + Age + PTA_mean + AgeSq + Hemisphere + TinnitusStatus + MotionAbsMean + MotionRelMean + (1|SubjectID)';
...
numCoefficients = size(fitlme(dataTable(dataTable.VertexID == uniqueVertices(1), :), 'Response ~ 1 + Sex + Age + PTA_mean + AgeSq + Hemisphere + TinnitusStatus + MotionAbsMean + MotionRelMean + Hemisphere:TinnitusStatus + Hemisphere:PTA_mean + (1|SubjectID)').Coefficients, 1);
...
parfor i = 1:length(uniqueVertices)
    ...
    % Define the formula for the LME model
    lmeFormula = 'Response ~ 1 + Sex + Age + PTA_mean + AgeSq + Hemisphere + TinnitusStatus + MotionAbsMean + MotionRelMean + Hemisphere:TinnitusStatus + Hemisphere:PTA_mean + (1|SubjectID)';
...
filename = '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/GCOR_lme.mat';
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_tinStat_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_tinStat_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_PTA_mean_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_PTA_mean_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_hemis-PTA_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_hemis-PTA_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_Age_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_Age_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_MotionAbsMean_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_MotionAbsMean_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_MotionRelMean_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_MotionRelMean_fullMod_corrected_%g.mgz', alpha));
end
...
for idx = 1:length(alphas)
    ...
    MRIwrite(imgDataUncorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_AgeSq_fullMod_uncorrected_%g.mgz', alpha));
    ...
    MRIwrite(imgDataCorrected, sprintf('/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/GCOR_fssym/stat/with_motionParam/fullmod/GCOR_tmap_AgeSq_fullMod_corrected_%g.mgz', alpha));
end
