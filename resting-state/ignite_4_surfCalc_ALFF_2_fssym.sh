...
# Calculating ALFF in surface space (fsavg_sym), create merged_mean images before calculate stimEffect
...
mkdir -p "/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/ALFF_fssym/merge_mean"
