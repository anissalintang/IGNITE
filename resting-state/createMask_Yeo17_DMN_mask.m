...
MRIwrite(mri, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/destrieux_fsavg/DMN_mask_Yeo_lh.mgh');

% Save the mask -rh
mri.vol = mask_rh_2D;
mri.volsize = size(mask_rh_2D);
MRIwrite(mri, '/Volumes/gdrive4tb/IGNITE/resting-state/surface/analysis/destrieux_fsavg/DMN_mask_Yeo_rh.mgh');
