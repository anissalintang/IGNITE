...
imgorig= MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/preprocessed/IGTTKA_00017/IGTTKA_00017_sparse_rest_orig.nii.gz');
imgpe0= MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/preprocessed/IGTTKA_00017/IGTTKA_00017_sparse_rest_pe0.nii.gz');
imgpe1= MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/preprocessed/IGTTKA_00017/IGTTKA_00017_sparse_rest_pe1.nii.gz');


goodimgorig=MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/preprocessed/IGNTFA_00065/IGNTFA_00065_sparse_rest_orig.nii.gz');
goodimgpe0=MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/preprocessed/IGNTFA_00065/IGNTFA_00065_sparse_rest_pe0.nii.gz');
goodimgpe1=MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/preprocessed/IGNTFA_00065/IGNTFA_00065_sparse_rest_pe1.nii.gz');
%% from the bad image
...
MRIwrite(flipped_imgorig_struct, '/Volumes/gdrive4tb/IGNITE/sparse_rest/preprocessed/IGTTKA_00017/IGTTKA_00017_sparse_rest_orig.nii.gz');
MRIwrite(flipped_imgpe0_struct, '/Volumes/gdrive4tb/IGNITE/sparse_rest/preprocessed/IGTTKA_00017/IGTTKA_00017_sparse_rest_pe0.nii.gz');
MRIwrite(flipped_imgpe1_struct, '/Volumes/gdrive4tb/IGNITE/sparse_rest/preprocessed/IGTTKA_00017/IGTTKA_00017_sparse_rest_pe1.nii.gz');
