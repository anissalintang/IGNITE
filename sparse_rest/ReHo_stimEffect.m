...
subjects = subjects(~ismember({subjects.name}, {'.', '..','merge_mean', ...
    ...
    'hearingEffect'})); % Removed other unwanted directories
...
diffCondition_lh = mean(cat(1, lh_vis_data.imgData), 1,'omitnan') - mean(cat(1, lh_rest_data.imgData), 1,'omitnan');
diffCondition_rh = mean(cat(1, rh_vis_data.imgData), 1,'omitnan') - mean(cat(1, rh_rest_data.imgData), 1,'omitnan');
...
MRIwrite(diffCondition_lh_img, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/stimEffect/ReHo_lh_stimEffect_VS_NS.mgz');
MRIwrite(diffCondition_rh_img, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal//stimEffect/ReHo_rh_stimEffect_VS_NS.mgz');
