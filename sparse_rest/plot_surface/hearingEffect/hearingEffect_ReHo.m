...
%% ReHo hearingEffect
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/hearingEffect/ReHo_lh_hearingEffect_pctl.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/hearingEffect/ReHo_rh_hearingEffect_pctl.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('ReHo Hearing effect')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/ReHo_hearingEffect_pctl.png');
