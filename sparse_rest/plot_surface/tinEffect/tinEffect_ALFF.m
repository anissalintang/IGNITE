...
%% ALFF all
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFFall/tinEffect/smooth5/ALFF_lh_tinEffect_tin_noTin_smooth5.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFFall/tinEffect/smooth5/ALFF_rh_tinEffect_tin_noTin_smooth5.mgz');
data1 = img1.vol;
data2 = img2.vol;
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/ALFF_tinEffect_noTin_tin.png');
