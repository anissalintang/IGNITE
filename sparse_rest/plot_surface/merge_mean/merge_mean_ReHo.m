...
alpha_lhs(isnan(data1) | data1 == 0) = 0; % Set alpha to 0 for data < 0
...
alpha_rhs(isnan(data2) | data2 == 0) = 0; % Set alpha to 0 for data < 0
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/allSubj_ReHo_merge_mean_noTin_smooth5.png');
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/allSubj_ReHo_merge_mean_tin_smooth5.png');
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/allSubj_ReHo_merge_mean_noTin_rest_smooth5.png');
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/allSubj_ReHo_merge_mean_noTin_vis_smooth5.png');
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/allSubj_ReHo_merge_mean_tin_rest_smooth5.png');
...
saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/allSubj_ReHo_merge_mean_tin_vis_smooth5.png');
