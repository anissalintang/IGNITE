...
%% ALFF stimEffect VS-NS
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFF/stimEffect/ALFF_lh_stimEffect_VS_NS.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFF/stimEffect/ALFF_rh_stimEffect_VS_NS.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('ALFF VS vs NS')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/ALFF_stimEffect_VS_NS.png');
