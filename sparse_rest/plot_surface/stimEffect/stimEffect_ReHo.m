...
%% ReHo stimEffect VS-NS
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/stimEffect/ReHo_lh_stimEffect_VS_NS.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/stimEffect/ReHo_rh_stimEffect_VS_NS.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('ReHo VS vs NS')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/ReHo_stimEffect_VS_NS.png');
