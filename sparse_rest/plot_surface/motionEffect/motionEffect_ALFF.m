...
%% ALFF motionEffect
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFF/motionEffect/ALFF_lh_motionEffect_pctl.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFF/motionEffect/ALFF_rh_motionEffect_pctl.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
scaled_data = (min(max(all_data, -1.2), 1.2) + 1.2) / (1.2*2);
...
sgtitle('ALFF Motion effect')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/ALFF_motionEffect_pctl.png');
