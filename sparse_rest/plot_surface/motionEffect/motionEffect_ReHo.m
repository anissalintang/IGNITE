...
%% ReHo motionEffect
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/motionEffect/ReHo_lh_motionEffect_rel_pctl.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/motionEffect/ReHo_rh_motionEffect_rel_pctl.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
scaled_data = (min(max(all_data, -0.05), 0.05) + 0.05) / (0.05*2);
...
% Adjust the position of the axes (L-R,up-down,width, height)
...
sgtitle('ReHo Motion effect')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/ReHo_motionEffect_rel_pctl.png');
