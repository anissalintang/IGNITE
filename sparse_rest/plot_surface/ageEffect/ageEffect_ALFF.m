...
%% ALFF ageEffect
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFF/ageEffect/ALFF_lh_ageEffect_pctl.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFF/ageEffect/ALFF_rh_ageEffect_pctl.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
sgtitle('ALFF Age effect (percentiles)')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/ALFF_ageEffect_pctl_older_younger.png');