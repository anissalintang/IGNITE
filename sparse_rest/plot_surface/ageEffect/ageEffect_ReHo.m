...
%% ReHo ageEffect
img1 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/ageEffect/ReHo_lh_ageEffect_pctl.mgz');
img2 = MRIread('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/ageEffect/ReHo_rh_ageEffect_pctl.mgz');
data1 = img1.vol';
data2 = img2.vol';
...
scaled_data = (min(max(all_data, -0.025), 0.025) + 0.025) / (0.025*2);
...
sgtitle('ReHo Age effect (percentiles)')

saveas(gcf, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/keyFigures/ReHo_ageEffect_pctl_older_younger.png');