...
for subj = 1:length(subjects)
    ...
    motionAbsMean = csvData.MotionRelMean_sparse_rest(subjIdx);
...
motionEffect_lh = mean(cat(1, higherMotion_lh.imgData), 1,'omitnan') - mean(cat(1, lowerMotion_lh.imgData), 1,'omitnan');
motionEffect_rh = mean(cat(1, higherMotion_rh.imgData), 1,'omitnan') - mean(cat(1, lowerMotion_rh.imgData), 1,'omitnan');

% Save the motion effect as images in .mgz
saveMotionEffect(motionEffect_lh, imgDataOri, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/motionEffect/ReHo_lh_motionEffect_rel_pctl.mgz');
saveMotionEffect(motionEffect_rh, imgDataOri, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/motionEffect/ReHo_rh_motionEffect_rel_pctl.mgz');
