...
proj_path="/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/projected/fssym/nonSmoothed/filt_0.01-0.1"
...
mkdir -p "/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo_fssym"

for s in ${subj[@]}; do
	mkdir -p "/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo_fssym/${s}"
done
reho_path="/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo_fssym"

# ======================================================================= #
# Both hemispheres (whole-brain)
# for s in ${subj[@]}; do
# 	matlab -batch "fsmerge('${proj_path}/${s}/${s}_lh_filt01_fsavg_onlh_fssym.mgz','${proj_path}/${s}/${s}_rh_filt01_fsavg_onlh_fssym.mgz','${reho_path}/${s}/${s}_bothHemi.mgz','x')" -nojvm
# done
