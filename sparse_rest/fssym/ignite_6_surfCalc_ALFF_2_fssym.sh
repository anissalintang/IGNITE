...
alff_path="/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFF_fssym"
...
# mkdir -p "/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ALFF_fssym/merge_mean"

# # Merge ALFF_fssym - NON SMOOTHED
# for h in ${hemi[@]}; do
