...
PTAEffect_lh = mean(cat(1, higherPTA_lh.imgData), 1,'omitnan') - mean(cat(1, lowerPTA_lh.imgData), 1,'omitnan');
PTAEffect_rh = mean(cat(1, higherPTA_rh.imgData), 1,'omitnan') - mean(cat(1, lowerPTA_rh.imgData), 1,'omitnan');

% Save the PTA effect as images in .mgz
savePTAEffect(PTAEffect_lh, imgDataOri, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/hearingEffect/ReHo_lh_hearingEffect_pctl.mgz');
savePTAEffect(PTAEffect_rh, imgDataOri, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHo/temporal/hearingEffect/ReHo_rh_hearingEffect_pctl.mgz');
