%% Calculate ReHo tinnitus effect
% Loop over the hemispheres
clear
clc
mkdir(fullfile('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHoall/temporal'), 'tinEffect');
% Define the parent folder where all of the subject folders are located
parent_folder = '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHoall/temporal/merge_mean/';
...
for hem = 1:length(hemispheres)
    ...
    for tin = 1:length(tinnitus)
        ...
        filename = ['allSubj_', hemispheres{hem}, '_ReHoall_merged_mean_', tinnitus{tin}, '_smooth5.mgz'];
...
mkdir(fullfile('/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHoall/temporal/'), 'tinEffect');
MRIwrite(lh_tin_noTin_img, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHoall/temporal/tinEffect/ReHo_lh_tinEffect_tin_noTin_smooth5.mgz');
MRIwrite(rh_tin_noTin_img, '/Volumes/gdrive4tb/IGNITE/sparse_rest/surface/analysis/ReHoall/temporal/tinEffect/ReHo_rh_tinEffect_tin_noTin_smooth5.mgz');
